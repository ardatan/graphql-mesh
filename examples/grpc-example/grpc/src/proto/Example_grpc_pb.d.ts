...
interface IExampleService_ISearchMoviesByCast
  extends grpc.MethodDefinition<Example_pb.SearchByCastRequest, Example_pb.Movie> {
...
export interface IExampleClient {
  getMovies(
    ...
    callback: (error: grpc.ServiceError | null, response: Example_pb.MoviesResult) => void
  ...
  searchMoviesByCast(
    request: Example_pb.SearchByCastRequest,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<Example_pb.Movie>;
  searchMoviesByCast(
    request: Example_pb.SearchByCastRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
