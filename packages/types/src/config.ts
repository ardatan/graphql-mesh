...
export interface RenameBareTransformObject {
  from: RenameBareConfig;
  to: RenameBareConfig1;
}
export interface RenameBareConfig {
  type?: string;
  field?: string;
}
export interface RenameBareConfig1 {
  type?: string;
  field?: string;
}
