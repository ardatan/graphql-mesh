...
describe('getComposerFromJSONSchema', () => {
  it('should return JSON scalar if given schema is boolean true', () => {
    const result = getComposerFromJSONSchema(true);
    expect(result.input.getType()).toBe(GraphQLJSON);
    expect((result.output as ScalarTypeComposer).getType()).toBe(GraphQLJSON);
  });
  it('should generate a new scalar type that validates the value against the given pattern in string schema', () => {
    const pattern = '^\\d{10}$';
  ...
  it('should generate a new scalar type that validates the value against the given const in string schema', () => {
    const constStr = 'FOO';
  ...
  it('should generate a new enum type from enum schema', () => {
...
enum ExampleEnum {
  ...
  it('should generate a new enum type from enum schema by sanitizing enum keys', () => {
...
enum ExampleEnum {
  ...
  it('should generate union types from oneOf object types', () => {
    const inputSchema: JSONSchema = {
      title: 'User',
      type: 'object',
      oneOf: [
...
type ExampleAllOf {
  ...
  it('should generate JSON scalar for allOf definitions that contain scalar types', () => {
  ...
  it('should generate correct types for anyOf definitions', () => {
    const inputSchema: JSONSchema = {
      title: 'ExampleAnyOf',
      anyOf: [
        {
...
type ExampleAnyOf {
  ...
  it('should return Boolean for boolean definition', () => {
    const inputSchema = {
      type: 'boolean',
    };
  ...
  it('should return Void for null definition', () => {
    const inputSchema = {
      type: 'null',
    };
  ...
  it('should return BigInt for int64 definition', () => {
    const inputSchema = {
      type: 'integer',
      format: 'int64',
    };
  ...
  it('should return Int for int32 definition', () => {
    const inputSchema = {
      type: 'integer',
      format: 'int32',
    };
  ...
  it('should return Int for integer definitions without format', () => {
    const inputSchema = {
      type: 'integer',
    };
  ...
  it('should return Float for number definition', () => {
    const inputSchema = {
      type: 'number',
    };
  ...
  it('should generate scalar types for minLength definition', () => {
  ...
  it('should generate scalar types for maxLength definition', () => {
    const title = 'NonEmptyString';
    const inputSchema = {
      title,
      type: 'string',
  ...
  it('should generate scalar types for both minLength and maxLength definition', () => {
    const title = 'NonEmptyString';
    const inputSchema = {
      title,
      type: 'string',
  ...
  it('should return DateTime scalar for date-time format', () => {
    const inputSchema = {
      type: 'string',
      format: 'date-time',
    };
  ...
  it('should return Time scalar for time format', () => {
    const inputSchema = {
      type: 'string',
      format: 'time',
    };
  ...
  it('should return Date scalar for date format', () => {
    const inputSchema = {
      type: 'string',
      format: 'date',
    };
  ...
  it('should return EmailAddress scalar for email format', () => {
    const inputSchema = {
      type: 'string',
      format: 'email',
    };
  ...
  it('should return IPv4 scalar for email format', () => {
    const inputSchema = {
      type: 'string',
      format: 'ipv4',
    };
  ...
  it('should return IPv6 scalar for email format', () => {
    const inputSchema = {
      type: 'string',
      format: 'ipv6',
    };
  ...
  it('should return URL scalar for uri format', () => {
    const inputSchema = {
      type: 'string',
      format: 'uri',
    };
  ...
  it('should return String for string definitions without format', () => {
    const inputSchema = {
      type: 'string',
    };
    const result = getComposerFromJSONSchema(inputSchema);
  ...
  it('should return list type for array definitions with items as object', () => {
    const inputSchema = {
      type: 'array',
      items: {
        type: 'string',
  ...
  it('should return generic JSON type for array definitions with contains', () => {
  ...
  it('should return union type inside a list type if array definition has items as an array', () => {
...
`.trim()
  ...
  it('should create correct object types from object definition', () => {
...
type ExampleObject {
  ...
  it('should create correct object types from object definition with additionalPropertiez', () => {
    const title = 'ExampleObject';
    const inputSchema = {
      title,
      type: 'object',
...
type ExampleObject {
  ...
  it('should return GraphQLSchema if object definition given with _schema title', () => {
    const inputSchema = {
      title: '_schema',
      type: 'object',
      properties: {
    ...
    const { output } = getComposerFromJSONSchema(inputSchema);
...
type Query {
  ...
  it('should return Query type if object definition given with Query title', () => {
    const inputSchema = {
      title: 'Query',
      type: 'object',
      properties: {
...
type Query {
  ...
  it('should return Mutation type if object definition given with Query title', () => {
    const inputSchema = {
      title: 'Mutation',
      type: 'object',
      properties: {
...
type Mutation {
  ...
  it('should return Subscription type if object definition given with Subscription title', () => {
    const inputSchema = {
      title: 'Subscription',
      type: 'object',
      properties: {
...
type Subscription {
  ...
  it('should add arguments to Query fields with the object definition QueryTitle', () => {
    const inputSchema = {
      title: '_schema',
      type: 'object',
      properties: {
