...
- [#5408](https://github.com/ardatan/graphql-mesh/pull/5408)
  [`303c71c`](https://github.com/ardatan/graphql-mesh/commit/303c71c1a7afa7cf7befbc7ebca38a786db6c307)
  Thanks [@dr3](https://github.com/dr3)! - Fix invalid schema AST after filtering out empty root
  operation types (e.g. Mutation.!*), so follow-up transforms like extend can merge schemas without
  `Unknown type "Mutation"`.
