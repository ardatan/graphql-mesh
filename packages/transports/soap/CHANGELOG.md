...
- [#9586](https://github.com/ardatan/graphql-mesh/pull/9586)
  ...
  - Updated dependency
    [`@graphql-tools/executor@^1.5.7` ↗︎](https://www.npmjs.com/package/@graphql-tools/executor/v/1.5.7)
    (from `^1.5.5`, in `dependencies`)
  - Updated dependency
...
- [#9465](https://github.com/ardatan/graphql-mesh/pull/9465)
  ...
  - Updated dependency
    [`@graphql-tools/executor@^1.5.4` ↗︎](https://www.npmjs.com/package/@graphql-tools/executor/v/1.5.4)
...
- [#9547](https://github.com/ardatan/graphql-mesh/pull/9547)
  ...
  - Updated dependency
    [`@graphql-tools/executor@^1.5.5` ↗︎](https://www.npmjs.com/package/@graphql-tools/executor/v/1.5.5)
    (from `^1.5.4`, in `dependencies`)
  - Updated dependency
...
- [#9477](https://github.com/ardatan/graphql-mesh/pull/9477)
  [`cd30910`](https://github.com/ardatan/graphql-mesh/commit/cd30910ee1ce2c4bb6ad8f3c7cd051dec5493c3c)
  Thanks [@zcag](https://github.com/zcag)! - Fix query args taking priority over `soapHeaders`
  loader config in namespace-aware SOAP executor.

  When both a WSDL-declared `<soap:header>` arg and the loader-level `soapHeaders` config contribute
  content to the same XML header element, the config entry previously ran last and silently
  overwrote the value supplied by the caller.

  The fix seeds `soap:Header` from the `soapHeaders` config first, then lets the args loop overwrite
  on key collision — so explicit query arguments always take priority over static loader defaults.
  Args that GraphQL coerces to an empty/absent value (null, undefined, `""`, or `{}`) are not
  treated as intentional overrides and leave the config-supplied default in place.
