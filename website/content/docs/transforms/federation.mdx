...
title: Federation Subgraph Transform
sidebarTitle: Federation Subgraph
---
...
```ts title="userResolveReference.ts"
...
import API from '../../../generated/FederationTransform.generated.md'
