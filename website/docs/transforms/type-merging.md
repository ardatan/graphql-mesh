...
[Merging types from different sources (using Type Merging)#](http://localhost:3000/docs/recipes/multiple-apis#merging-types-from-different-sources-using-type-merging) chapter first.
