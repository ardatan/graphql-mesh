...
Get started by learning the GraphQL Mehs [concepts](/docs/getting-started/concepts) and build your first [Gateway](/docs/getting-started/your-first-mesh-gateway)!
