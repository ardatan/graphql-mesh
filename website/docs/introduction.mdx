...
However, most of those approaches [require much coding, maintenance or don't support non-GraphQL sub-services](/docs/comparison).
...
Get started by learning the GraphQL Mesh [concepts](/docs/getting-started/concepts) and build your first [Gateway](/docs/getting-started/your-first-mesh-gateway)!
