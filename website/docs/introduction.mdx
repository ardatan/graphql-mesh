...
However, most of those approaches [require much coding, maintenance or don't support non-GraphQL sub-services](/docs/comparaison).
...
Already used in production by community members and [some of our clients](https://www.the-guild.dev/services), GraphQL Mesh can be used for the following use-cases:
...
- **Safely and efficiently expose some part of a Database** as a GraphQL API


Get started by learning those [concepts](/docs/getting-started/concepts) and build your first [GraphQL Mesh Gateway](/docs/getting-started/your-first-mesh-gateway)!
