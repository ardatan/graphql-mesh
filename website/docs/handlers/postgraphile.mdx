...
<PackageInstall packages="@graphql-mesh/postgraphile" />
...
<PackageInstall packages="@graphile/federation" />
...
If you want to have automatic many-to-many mapping across your entities. You can install `@graphile-contrib/pg-many-to-many` and add it under `appendPlugins`.

<PackageInstall packages="@graphile-contrib/pg-many-to-many" />
...
<PackageInstall packages="@graphile/postgis" />
