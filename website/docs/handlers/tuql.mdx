...
This handler allows you to use GraphQL schema created by [Tuql](https://github.com/bradleyboy/tuql), based on an SQLite database schema or an SQL dump file.

To get started, install the handler library:

<PackageInstall packages="@graphql-mesh/tuql" />
