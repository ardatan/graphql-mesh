...
Just create a `json-samples` directory in your project root, and put the JSON samples in there (`responseSample: ./jsons/MyField.response.json` - Create a new folder like `Jsons`).
