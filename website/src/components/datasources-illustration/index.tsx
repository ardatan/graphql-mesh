  ...
  return (
    ...
    >
      ...
      <div className="col-start-3 col-span-4 row-start-3 flex justify-center">
        <div className="relative z-10 items-center justify-center gap-4 rounded-2xl p-4 xl:gap-4 xl:py-[22px] bg-gradient-to-br from-[#4F6C6A] to-[#004540] cursor-pointer transition-colors duration-500 [&>svg]:shrink-0 lg:px-12 xl:px-16 py-6 backdrop-blur-sm flex flex-col text-center">
