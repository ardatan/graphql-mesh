---
description:
  'Build GraphQL Gateways easily with GraphQL Mesh. Consume many API/Sources types, extend the
  schema with custom resolvers, and more. Get started now! #GraphQL #Mesh'
---
