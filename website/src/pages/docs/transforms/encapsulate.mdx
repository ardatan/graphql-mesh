---
description:
  "Improve your GraphQL schema organization with 'encapsulate' transform. Easily encapsulate a
  specific schema into a single field with GraphQL Mesh. #GraphQL #Mesh"
---
