---
description:
  "Conform to the federation specification with GraphQL Mesh's federation transform. Reuse source
  code for compliance and use complex business logic with code file resolvers. #GraphQL #Mesh"
---
