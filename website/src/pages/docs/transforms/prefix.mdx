---
description: "Add prefixes to GraphQL types and operations using Prefix Transform in GraphQL Mesh. Simplify complicated names, avoid conflicts, and "namespace" APIs easily. Learn how to use it with examples and API reference."
---
