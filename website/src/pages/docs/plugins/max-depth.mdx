---
description: "Protect your GraphQL API from malicious nested selection sets with maxDepth plugin in GraphQL Mesh. Learn more and get started with graphql-armor-max-depth now. #GraphQL #Mesh"
---
...
<PackageCmd packages={['@escape.tech/graphql-armor-max-depth']} />
