---
description: "Discover the snapshot plugin in GraphQL Mesh - apply snapshots of remote data sources for development use, manipulate data, and see how your API mesh responds. Learn how to use it in our example with SOAP handler. #GraphQL #Mesh"
---
...
<PackageCmd packages={['@graphql-mesh/plugin-snapshot']} />
