---
description: "Protect your GraphQL server from performance degradation with the 'maxTokensPlugin'. Limit the number of allowed tokens in a document and reject malicious operations. Learn more with GraphQL Inspector. #GraphQL @Mesh"
---
