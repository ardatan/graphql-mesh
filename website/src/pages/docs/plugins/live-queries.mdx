---
description:
  "Use GraphQL Mesh's Live Queries to update GraphQL operation results automatically. Learn how to
  configure the Live Query plugin with examples and a code sandbox demo. #GraphQL #Mesh"
---
