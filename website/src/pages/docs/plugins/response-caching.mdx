...
<Callout>
  ...
  [Localforage](/docs/cache/localforage) as a cache storage. For example, you need to follow this section to configure
  [Redis](/docs/cache/redis) as your cache storage. You can find other options under the same category.
</Callout>
