---
description: "Collect and send metrics to Datadog's DogStatsD and InfluxDB's Telegraf StatsD services using @graphql-mesh/plugin-statsd plugin. Available metrics include operations count, error count, and latency. #GraphQL @Mesh"
---
