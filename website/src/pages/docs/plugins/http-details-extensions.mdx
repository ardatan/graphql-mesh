---
description: "Expose outgoing HTTP requests details from GraphQL Mesh source handlers in extensions for better monitoring with @graphql-mesh/plugin-http-details-extensions. #GraphQL #Mesh"
---
