---
description: "Protect your GraphQL server from CSRF attacks with the @graphql-yoga/plugin-csrf-prevention plugin. Install it with just one command! #GraphQL #Mesh"
---
