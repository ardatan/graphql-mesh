---
description: "Learn how to configure your GraphQL Mesh API using sources, transforms, plugins, caching, and more. Check out the MeshRC.yaml reference now! #GraphQL #Mesh"
---
...
GraphQL Code Generator Configuration. [Read
more](/docs/guides/graphql-code-generator#customizing-the-graphql-code-generator-configuration
