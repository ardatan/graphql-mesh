---
description: "Boost GraphQL performance with GraphQL Mesh's cache storage options: file, LocalForage, CloudFlare Workers KV, and Redis. Read our docs for more info. #GraphQL"
---
# Cache Storages
