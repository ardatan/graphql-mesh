---
description: "Learn about GraphQL Mesh CLI commands, such as mesh dev, build, validate, start, and serve-source. Customize options with global flags. #GraphQL #Mesh"
---
...
- validation of the mesh configuration (see
  [`packages/types/src/config-schema.json`](https://github.com/Urigo/graphql-mesh/blob/master/packages/types/src/config-schema.json))
