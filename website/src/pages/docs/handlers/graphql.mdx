---
description: "GraphQL Mesh is a schema-stitching tool that enables loading remote GraphQL schemas, fetched from a CDN or registry, and using them with schema-stitching based on graphql-tools. #GraphQL #Mesh"
---
...
If you use [GraphQL Hive](https://graphql-hive.com/) to manage your GraphQL APIs as a schema
registry, you can use the following configuration to fetch your schema from Hive:
