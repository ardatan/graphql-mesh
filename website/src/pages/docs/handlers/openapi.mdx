---
description: "Load remote or local OpenAPI and Swagger schemas with GraphQL Mesh OpenAPI/ Swagger handler.
Migrate from older versions, and override default Query/Mutation operations classification.
Accept cookies, headers, and context values with advanced cookie handling. #GraphQL #Mesh"
---
