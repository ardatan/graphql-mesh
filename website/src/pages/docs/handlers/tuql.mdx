---
description: "Use GraphQL schema created by Tuql for SQLite databases or SQL dump files with GraphQL Mesh's Tuql handler. Install @graphql-mesh/tuql and get started! #GraphQL #Mesh"
---
...
<PackageCmd packages={['@graphql-mesh/tuql']} />
