---
description: "Generate GraphQL schema from MySQL database with GraphQL Mesh. Learn how to use the MySQL handler and its powerful 'where' field. Install now with PackageCmd. #GraphQL #Mesh"
---
...
<PackageCmd packages={['@graphql-mesh/mysql']} />
