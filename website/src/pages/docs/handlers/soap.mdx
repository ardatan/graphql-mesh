---
description: "Generate executable schema for SOAP services with GraphQL Mesh's SOAP handler. Consume WSDL files and get started easily. @graphql-mesh/soap. #GraphQL #Mesh"
---
