---
description: "Maximize your GraphQL API capabilities with GraphQL Mesh! Seamlessly consume various data sources like PostgreSQL, MongoDB, Neo4j, and more. #GraphQL #Mesh"
---
# Source Handlers
...
| `@graphql-mesh/openapi`      | Available | [Swagger, OpenAPI 2/3](https://swagger.io)                                                                                                                                                       | [docs](/docs/handlers/openapi)      |
