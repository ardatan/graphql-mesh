---
description:
  "Easily generate executable schema for Apache Thrift services with GraphQL Mesh's Thrift handler.
  Get started by installing @graphql-mesh/thrift. #GraphQL #Mesh"
---
