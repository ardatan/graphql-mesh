...
<Callout>
  ...
  restart it if you don't configure `polling`. If you configured it already, you don't even need to
  restart the server. GraphQL Mesh will pull the recent changes and update it automatically.
</Callout>
