...
<Callout>If you want to collect usage data for the [Insights tab](https://the-guild.dev/graphql/hive/product-updates/2023-09-28-introducing-graphql-api-consumer-insights-page) in hive, you must include the `usage` attribute in the hive section of the configuration.
...
See the config section below for more usage configuration options.
</Callout>
