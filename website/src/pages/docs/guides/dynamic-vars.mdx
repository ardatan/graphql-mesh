---
description: "Learn how to use dynamic values in GraphQL Mesh configuration setup with env and runtime variables, including operation-specific and globally available variables. #GraphQL #Mesh"
---
...
[federation example](https://github.com/Urigo/graphql-mesh/blob/master/examples/federation-example/gateway/.meshrc.yml#L16),
