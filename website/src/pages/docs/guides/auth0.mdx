---
description: "Learn how to add authentication to your GraphQL API using Auth0 with @envelop/auth0 plugin. Follow the steps to configure Auth0 and integrate it into your Mesh setup. #GraphQL #Mesh"
---
