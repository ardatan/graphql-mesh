...
- **StatsD**: collect and send metrics to Datadog's DogStatsD and InfluxDB's Telegraf StatsD services. [Read more](./docs/plugins/statsd.mdx)
- **Prometheus**: expose and collect metrics to Prometheus. [Read more](./docs/plugins/prometheus.mdx)
- **NewRelic**: tracing, monitoring and error reporting with NewRelic. [Read more](./docs/plugins/new-relic.mdx)
