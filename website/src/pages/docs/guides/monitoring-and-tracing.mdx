...
You can use GraphQL Mesh plugins to trace and monitor your GraphQL Mesh gateway's GraphQL execution flow together with all outgoing HTTP calls and internal query planning.
GraphQL Mesh plugins are extended versions of [the existing Envelop plugins.](https://www.envelop.dev/docs/guides/monitoring-and-tracing)
...
All you have to do is just enable the following flag;
```yaml
...
[See here for more advances options](https://github.com/n1ru4l/envelop/blob/main/packages/plugins/newrelic/README.md#agent-configuration)
