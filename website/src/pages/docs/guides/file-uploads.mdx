---
description: "GraphQL Mesh enables easy file uploads with its built-in support for GraphQL Yoga server. Forward file uploads to sources with minimal configuration changes. Check out the example in the documentation for more details. #GraphQL @Mesh"
---
# File uploads
...
[`examples/graphql-file-upload-example/.meshrc.yml`](https://github.com/Urigo/graphql-mesh/tree/master/examples/graphql-file-upload-example/.meshrc.yml).
