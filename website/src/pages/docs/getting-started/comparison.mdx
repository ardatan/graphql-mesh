...
- creating a [GraphQL Gateway](https://the-guild.dev/graphql/hive/federation) from scratch using GraphQL tools (ex: `stitchSchemas()`)
- use [GraphQL Federation](https://the-guild.dev/graphql/hive)
