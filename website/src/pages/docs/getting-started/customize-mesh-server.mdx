---
description: "Learn how to customize your Mesh server with GraphQL Yoga and Envelop, and take advantage of out-of-the-box features such as persisted queries, live queries, files upload, and serverless deployment. Configure or replace the server implementation with plugins and a standalone solution. #GraphQL #Mesh"
---
