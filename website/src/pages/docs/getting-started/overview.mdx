---
description: "GraphQL Mesh allows you to create a unified GraphQL schema from multiple sources, using handlers and transforms. Configure sources, handlers, and transforms in a .mesh.yaml file to build your first gateway. #GraphQL #Mesh"
---
# Overview
