---
description: "Learn how to configure sources with no definition using GraphQL Mesh. Use the jsonSchema handler to provide a definition of APIs that don't provide an API definition. #GraphQL #Mesh"
---
