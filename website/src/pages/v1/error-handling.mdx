...
automatically. To add or override typed error responses, update your OpenAPI document to include the
desired response schema (or example) for the relevant status code.
