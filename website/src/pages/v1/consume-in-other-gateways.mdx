...
subgraph, and serve the subgraph with [Hive Gateway](https://graphql-hive.com/docs/gateway) But if
you use Hive Gateway, you don't need to worry about this, then you can use the supergraph directly
without having multiple servers.

That's because other gateways are not aware of Mesh Compose's additional directives to handle the
non-federated sources.

This means you can use non-federated sources in any [Federation](https://the-guild.dev/graphql/hive/federation) compliant gateway such as Apollo
