...
# Migration from GraphQL Mesh v0
...
- If you deploy GraphQL Mesh v0 by using the http handler provided in the artifacts under `.mesh`,
  ...
  [Hive Gateway's Deployment Guide](https://graphql-hive.com/docs/gateway/deployment) to deploy your
  gateway.
...
- GraphQL Mesh no longer generates Persisted Operations store. You should setup your gateway based
  on your needs.
  [See here](https://graphql-hive.com/docs/gateway/features/performance/persisted-operations) for
  more information.
...
Read more about [Hive Gateway's Deployment Guide](https://graphql-hive.com/docs/gateway/deployment)
to setup your gateway with the new artifacts.
