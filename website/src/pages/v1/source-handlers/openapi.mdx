...
See
[Subscriptions & Webhooks](https://the-guild.dev/graphql/hive/docs/gateway/subscriptions-webhooks)
to create an endpoint to consume a webhook. You should use the callback url as `pubSubTopic` in the
