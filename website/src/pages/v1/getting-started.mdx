...
served by [Hive Gateway](https://graphql-hive.com/docs/gateway/introduction) or other gateways such
as [Apollo Gateway, Apollo Router or Cosmo Router](/v1/consume-in-other-gateways).
...
- Extend the supergraph with
  [additional type definitions](/v1/configuration#extending-the-supergraph-using-additionaltypedefs)
...
- Generate a subgraph that is fully compatible with Federation tools so you can use it with any
  schema registry such as [Hive](https://graphql-hive.com/docs/gateway/schema-registry/hive) or
  [GraphOS](https://graphql-hive.com/docs/gateway/schema-registry/graphos)

## Installation

[Node.js](https://nodejs.org) is a pre-requisite for Hive Gateway. You can install Compose CLI with
...
<Callout>[In order to serve the supergraph, you need to setup Hive Gateway](/v1/serve).</Callout>

## Generating the individual subgraphs for Schema Registry

If you want to publish the subgraphs to a schema registry such as
[Hive](https://graphql-hive.com/docs/gateway/schema-registry/hive) or
[GraphOS](https://graphql-hive.com/docs/gateway/schema-registry/graphos), you can generate the
subgraphs by running the following command:
...
[Hive Gateway](https://graphql-hive.com/docs/gateway/introduction).
...
<Cards>
  <Cards.Card arrow title="Serve the generated API with Hive Gateway" href="/v1/serve" />
  <Cards.Card
    arrow
