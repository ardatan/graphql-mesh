...
- Generate a subgraph that is fully compatible with Federation tools so you can use it with any
  schema registry such as [Hive](https://graphql-hive.com/docs/gateway/supergraph-proxy-source) or
  [GraphOS](https://graphql-hive.com/docs/gateway/supergraph-proxy-source)
...
<Callout>
  ...
  Gateway](https://graphql-hive.com/docs/gateway).
</Callout>

## Generating the individual subgraphs for Schema Registry

If you want to publish the subgraphs to a schema registry such as
[Hive](https://graphql-hive.com/docs/gateway/supergraph-proxy-source) or
[GraphOS](https://graphql-hive.com/docs/gateway/supergraph-proxy-source), you can generate the
...
Easiest way to run the supergraph is to use [Hive Gateway](https://graphql-hive.com/docs/gateway).
...
<Cards>
  <Cards.Card
    ...
    href="https://graphql-hive.com/docs/gateway"
  />
  <Cards.Card
    arrow
