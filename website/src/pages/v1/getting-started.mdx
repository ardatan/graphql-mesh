...
- Generate a subgraph that is fully compatible with Federation tools so you can use it with any
  schema registry such as [Hive](https://the-guild.dev/graphql/hive/docs/gateway/supergraph-proxy-source) or
...
[GraphOS](https://the-guild.dev/graphql/hive/docs/gateway/supergraph-proxy-source), you can generate the
...
Easiest way to run the supergraph is to use [Hive Gateway](https://the-guild.dev/graphql/hive/docs/gateway).
