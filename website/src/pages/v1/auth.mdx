...
[See here to configure Generic Auth plugin for Hive Gateway](https://graphql-hive.com/docs/gateway/features/auth/generic-auth)
...
<Callout>
  You can learn more about the auth directives in the gateway docs here. [Generic Auth in Hive
  Gateway](https://graphql-hive.com/docs/gateway/features/auth/generic-auth)
</Callout>
...
<Callout>
  ...
  Auth](https://graphql-hive.com/docs/gateway/features/auth/generic-auth) plugin to use **Complete
  Protection** in your GraphQL Mesh Gateway.
</Callout>
