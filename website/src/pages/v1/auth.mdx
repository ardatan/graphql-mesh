...
[See here to configure authentication for Hive Gateway](https://graphql-hive.com/docs/gateway/authorization-authentication)
...
<Callout>
  ...
  Gateway](https://graphql-hive.com/docs/gateway/authorization-authentication)
</Callout>
...
<Callout>
  ...
  Auth](https://graphql-hive.com/docs/gateway/authorization-authentication) plugin to use **Complete
