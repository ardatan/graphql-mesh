...
- [Authorization](/v1/serve/features/auth/generic-auth) on specific fields and types using
  Federation Auth directives such as `@requiresScopes` ,`@authenticated` and `@policy`
- Role-based Access Control either with directives or programmatically
...
- [Security](/v1/serve/features/security/index) features such as safelisting, depth limit etc
...
<Cards.Card arrow title="Start with Hive Gateway" href="/v1/serve/getting-started" />
