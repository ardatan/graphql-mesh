...
> The GraphQL Mesh plugin for JWT is based in the
> [GraphQL Yoga JWT plugin (`@graphql-yoga/plugin-jwt`)](https://github.com/dotansimha/graphql-yoga/tree/main/packages/plugins/jwt),
> with adjustments and improvements to easily work with GraphQL Mesh.
...
import { useExtractedJWT } from '@graphql-mesh/plugin-jwt-auth'
