...
```ts
import { ResolveUserFn } from '@graphql-mesh/serve-runtime'
...
```ts
import { ValidateUserFn } from '@graphql-mesh/serve-cli'
...
import { defineConfig, ResolveUserFn, ValidateUserFn } from '@graphql-mesh/serve-cli'
