...
<Callout>
  ...
  GraphQL schema and helps you to protect your GraphQL schema in a declarative way. [Learn more how
  to use it in your subgraphs during Mesh Compose](/v1/compose/auth).
</Callout>
