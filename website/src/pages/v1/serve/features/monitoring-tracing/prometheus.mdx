...
import grafanaScreenshot from '@/public/assets/grafana-prom.png'
...
You can use `@graphql-mesh/plugin-prometheus` plugin to expose and collect metrics from all phases
of your GraphQL execution including internal query planning and outgoing HTTP requests.
...
<Image
  ...
  placeholder="empty"
  className="mt-4"
  alt="Metrics visualized in Grafana"
/>
...
| ----------------------------------------------------------------------------------------- | -------- | :-------: | ------------------------------------------------------------ |
| [`graphql_yoga_http_duration`](#graphql_yoga_http_duration)                               | Enabled  | Histogram | duration of incoming (downstream) HTTP requests              |
| [`graphql_envelop_phase_parse`](#graphql_envelop_phase_parse)                             | Enabled  | Histogram | duration of the `parse` phase of the GraphQL execution       |
| [`graphql_envelop_phase_validate`](#graphql_envelop_phase_validate)                       | Enabled  | Histogram | duration of the `validate` phase of the GraphQL execution    |
| [`graphql_envelop_phase_context`](#graphql_envelop_phase_context)                         | Enabled  | Histogram | duration of the `context` phase of the GraphQL execution     |
| [`graphql_envelop_phase_execute`](#graphql_envelop_phase_execute)                         | Enabled  | Histogram | duration of the `execute` phase of the GraphQL execution     |
| [`graphql_envelop_phase_subscribe`](#graphql_envelop_phase_subscribe)                     | Enabled  | Histogram | duration of the `subscribe` phase of the GraphQL execution   |
| [`graphql_envelop_execute_resolver`](#graphql_envelop_execute_resolver)                   | Disabled | Histogram | duration of each resolver execution                          |
| [`graphql_envelop_request_duration`](#graphql_envelop_request_duration)                   | Enabled  | Histogram | duration of the complete GraphQL operation execution         |
| [`graphql_envelop_request_time_summary`](#graphql_envelop_request_time_summary)           | Enabled  |  Summary  | summary of the time spent on the GraphQL operation execution |
| [`graphql_envelop_error_result`](#graphql_envelop_error_result)                           | Enabled  |  Counter  | number of errors that was returned by the GraphQL execution  |
| [`graphql_envelop_request`](#graphql_envelop_request)                                     | Enabled  |  Counter  | number of GraphQL operations executed                        |
| [`graphql_envelop_deprecated_field`](#graphql_envelop_deprecated_field)                   | Enabled  |  Counter  | number of deprecated fields used in the GraphQL operation    |
| [`graphql_envelop_schema_change`](#graphql_envelop_schema_change)                         | Enabled  |  Counter  | number of schema changes that have occurred                  |
| [`graphql_gateway_fetch_duration`](#graphql_gateway_fetch_duration)                       | Enabled  | Histogram | duration of outgoing HTTP requests                           |
| [`graphql_gateway_subgraph_execute_duration`](#graphql_gateway_subgraph_execute_duration) | Enabled  | Histogram | duration of subgraph execution                               |
| [`graphql_gateway_subgraph_execute_errors`](#graphql_gateway_subgraph_execute_errors)     | Enabled  |  Counter  | number of errors that occurred during the subgraph execution |
...
```text
# HELP graphql_gateway_fetch_duration Time spent on outgoing HTTP calls
# TYPE graphql_gateway_fetch_duration histogram
graphql_gateway_fetch_duration_bucket{le="0.005",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="0.01",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="0.025",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="0.05",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="0.1",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="0.25",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="0.5",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="1",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="2.5",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="5",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="10",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 0
graphql_gateway_fetch_duration_bucket{le="+Inf",url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 2
graphql_gateway_fetch_duration_sum{url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 502
graphql_gateway_fetch_duration_count{url="https://upstream/graphql",method="POST",statusCode="200",statusText="OK"} 2
```
...
```text
# HELP graphql_gateway_subgraph_execute_duration Time spent on subgraph execution
# TYPE graphql_gateway_subgraph_execute_duration histogram
graphql_gateway_subgraph_execute_duration_bucket{le="0.005",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="0.01",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="0.025",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="0.05",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="0.1",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="0.25",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="0.5",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="1",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="2.5",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="5",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="10",subgraphName="upstream",operationType="query"} 0
graphql_gateway_subgraph_execute_duration_bucket{le="+Inf",subgraphName="upstream",operationType="query"} 2
graphql_gateway_subgraph_execute_duration_sum{subgraphName="upstream",operationType="query"} 889
graphql_gateway_subgraph_execute_duration_count{subgraphName="upstream",operationType="query"} 2
```
...
```text
# HELP graphql_gateway_subgraph_execute_errors Number of errors on subgraph execution
# TYPE graphql_gateway_subgraph_execute_errors counter
graphql_gateway_subgraph_execute_errors{subgraphName="upstream",operationType="query",operationName="Anonymous"} 1
```
...
it counts all errors found in the final response constructed by Mesh after it gathered all subgraph
...
# HELP graphql_gateway_delegate_duration Time spent on delegate execution
# TYPE graphql_gateway_delegate_duration histogram
