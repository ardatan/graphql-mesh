---
description:
  Learn how to track and analyze GraphQL execution metrics. Expose and collect data to optimize your
  gateway.
---
...
```ts filename="gateway.config.ts"
import { defineConfig, createHistogram } from '@graphql-mesh/serve-cli'
