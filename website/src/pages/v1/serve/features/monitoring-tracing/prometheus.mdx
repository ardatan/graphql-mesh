...
| `requestHeaders`  | A JSON encoded object containing the headers of the upstream request.  |
| `responseHeaders` | A JSON encoded object containing the headers of the upstream response. |
