...
import { createStdoutExporter, defineConfig } from '@graphql-mesh/serve-cli'
...
```ts filename="gateway.config.ts"
import { createOtlpHttpExporter, defineConfig } from '@graphql-mesh/serve-cli'
...
```ts filename="gateway.config.ts"
import { createOtlpGrpcExporter, defineConfig } from '@graphql-mesh/serve-cli'
...
```ts filename="gateway.config.ts"
import { createZipkinExporter, defineConfig } from '@graphql-mesh/serve-cli'
