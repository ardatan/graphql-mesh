...
[Learn more about persisted operations.](/v1/serve/features/performance/persisted-operations)
...
import { defineConfig as defineServeConfig, useDisableIntrospection } from '@graphql-mesh/serve-cli'
...
<Callout>
  ...
  For more information about `graphql-armor` features, you can refer to the [documentation for the plugin](/v1/serve/features/security/block-field-suggestions).
...
export const serveConfig = defineServeConfig({
  plugins: pluginCtx => [useDisableIntrospection(), blockFieldSuggestionsPlugin()]
})
```
