...
services:
  graphql-mesh:
    image: ghcr.io/ardatan/graphql-mesh:v1
    ports:
      - '4000:4000'
...
You can create a custom Docker image that inherits from the `ghcr.io/ardatan/graphql-mesh:v1` base
image.

```dockerfile
FROM ghcr.io/ardatan/graphql-mesh:v1
