...
Hive Gateway can serve the supergraph from a schema registry and report usage data to the registry.

## Built-in Integrations

Hive Gateway has built in support for the following schema registries.

<Cards>
  <Cards.Card arrow title="Hive Registry" href="/v1/serve/schema-registry/hive" />
