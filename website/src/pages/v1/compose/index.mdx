...
served by [Hive Gateway](/v1/serve/introduction) or other gateways such as
[Apollo Gateway, Apollo Router or Cosmo Router](/v1/compose/consume-in-other-gateways).
...
- [Transform subgraphs](/v1/compose/transforms) (rename, prefix, suffix fields and types etc.)
- Extend the supergraph with
  [additional type definitions](/v1/compose/configuration#extending-the-supergraph-using-additionaltypedefs)
- Adding an authentication layer using [auth directives](/v1/compose/auth)
...
<Callout>
  [See the source handlers section to learn more about handlers](/v1/compose/source-handlers).
</Callout>
...
Easiest way to run the supergraph is to use [Hive Gateway](/v1/serve/introduction).
...
<Cards>
  ...
  <Cards.Card
    ...
    href="/v1/compose/consume-in-other-gateways"
  />
</Cards>
