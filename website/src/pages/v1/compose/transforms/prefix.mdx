...
`Query/Mutation`). Prefix transform is similar to [Rename Transform](/v1/compose/transforms/rename)
in that it allows you to modify names to avoid conflicts, simplify complicated names, and change the
