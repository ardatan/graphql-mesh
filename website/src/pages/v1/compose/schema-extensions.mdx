...
You can use [Schema Extensions](/v1/compose/schema-extensions) with Hive. Since we don't have a
composition configuration of supergraph when we use a Hive project, we have to use Hive's settings
to configure `additionalTypeDefs`.
