...
directives are used to enforce authentication and authorization rules on your unified graph.
...
If you have completely protected unified graph but allow unauthenticated access for certain fields
by annotating them.
